...
(() => {
  ...
  loadPackage({
    "files": [ {
      "filename": "/assets/Inconsolata-Regular.ttf",
      "start": 0,
      "end": 84548
    }, {
      "filename": "/assets/checkpoint.aseprite",
      "start": 84548,
      "end": 86237
    }, {
      "filename": "/assets/checkpoint.png",
      "start": 86237,
      "end": 88128
    }, {
...
function fetchXHR(fetch, onsuccess, onerror, onprogress, onreadystatechange) {
  var url = _asan_js_load_4u((((fetch) + (8)) >> 2));
  if (!url) {
  ...
  requestMethod ||= "GET";
  var timeoutMsecs = _asan_js_load_4u((((fetch_attr) + (56)) >> 2));
  var userName = _asan_js_load_4u((((fetch_attr) + (68)) >> 2));
  var password = _asan_js_load_4u((((fetch_attr) + (72)) >> 2));
  var requestHeaders = _asan_js_load_4u((((fetch_attr) + (76)) >> 2));
  var overriddenMimeType = _asan_js_load_4u((((fetch_attr) + (80)) >> 2));
  var dataPtr = _asan_js_load_4u((((fetch_attr) + (84)) >> 2));
  var dataLength = _asan_js_load_4u((((fetch_attr) + (88)) >> 2));
  var fetchAttributes = _asan_js_load_4u((((fetch_attr) + (52)) >> 2));
  ...
  var xhr = new XMLHttpRequest;
  xhr.withCredentials = !!_asan_js_load_1u((fetch_attr) + (60));
  ...
  if (requestHeaders) {
    for (;;) {
      var key = _asan_js_load_4u(((requestHeaders) >> 2));
      if (!key) break;
      var value = _asan_js_load_4u((((requestHeaders) + (4)) >> 2));
      if (!value) break;
      requestHeaders += 8;
  ...
  _asan_js_store_4u(((fetch) >> 2), id);
  var data = (dataPtr && dataLength) ? HEAPU8.slice(dataPtr, dataPtr + dataLength) : null;
  function saveResponseAndStatus() {
    var ptr = 0;
    var ptrLen = 0;
    if (xhr.response && fetchAttrLoadToMemory && _asan_js_load_4u((((fetch) + (12)) >> 2)) === 0) {
    ...
    _asan_js_store_4u((((fetch) + (12)) >> 2), ptr);
    ...
    _asan_js_store_2((((fetch) + (40)) >> 1), xhr.readyState);
    _asan_js_store_2((((fetch) + (42)) >> 1), xhr.status);
...
function fetchCacheData(/** @type {IDBDatabase} */ db, fetch, data, onsuccess, onerror) {
  ...
  var fetch_attr = fetch + 112;
  var destinationPath = _asan_js_load_4u((((fetch_attr) + (64)) >> 2));
  destinationPath ||= _asan_js_load_4u((((fetch) + (8)) >> 2));
  ...
  try {
    ...
    putRequest.onsuccess = event => {
      _asan_js_store_2((((fetch) + (40)) >> 1), 4);
      _asan_js_store_2((((fetch) + (42)) >> 1), 200);
      stringToUTF8("OK", fetch + 44, 64);
      onsuccess(fetch, 0, destinationPathStr);
    };
    putRequest.onerror = error => {
      _asan_js_store_2((((fetch) + (40)) >> 1), 4);
      _asan_js_store_2((((fetch) + (42)) >> 1), 413);
...
function fetchLoadCachedData(db, fetch, onsuccess, onerror) {
  ...
  var fetch_attr = fetch + 112;
  var path = _asan_js_load_4u((((fetch_attr) + (64)) >> 2));
  path ||= _asan_js_load_4u((((fetch) + (8)) >> 2));
  ...
  try {
    ...
    getRequest.onsuccess = event => {
      if (event.target.result) {
        ...
        _asan_js_store_2((((fetch) + (40)) >> 1), 4);
        _asan_js_store_2((((fetch) + (42)) >> 1), 404);
...
function fetchDeleteCachedData(db, fetch, onsuccess, onerror) {
  ...
  try {
    ...
    request.onsuccess = event => {
      var value = event.target.result;
      _asan_js_store_4u((((fetch) + (12)) >> 2), 0);
...
function _emscripten_start_fetch(fetch, successcb, errorcb, progresscb, readystatechangecb) {
  runtimeKeepalivePush();
  var fetch_attr = fetch + 112;
  var onsuccess = _asan_js_load_4u((((fetch_attr) + (36)) >> 2));
  var onerror = _asan_js_load_4u((((fetch_attr) + (40)) >> 2));
  var onprogress = _asan_js_load_4u((((fetch_attr) + (44)) >> 2));
  var onreadystatechange = _asan_js_load_4u((((fetch_attr) + (48)) >> 2));
  var fetchAttributes = _asan_js_load_4u((((fetch_attr) + (52)) >> 2));
  var fetchAttrSynchronous = !!(fetchAttributes & 64);
  ...
  if (requestMethod === "EM_IDB_STORE") {
    var ptr = _asan_js_load_4u((((fetch_attr) + (84)) >> 2));
    var size = _asan_js_load_4u((((fetch_attr) + (88)) >> 2));
...
var wasmImports = {
  ...
  /** @export */ browser_get_height: browser_get_height,
  /** @export */ browser_get_width: browser_get_width,
